...
| 垃圾抽象 / Trashcore | [`prompts/trashcore/`](./prompts/trashcore/) | 60 条低清废片、五毛特效和无意义反转 / 60 lo-fi prompts with cheap effects and pointless twists |
...
│   ├── trashcore/     # 60 lo-fi prompts / 60 条垃圾抽象提示词
